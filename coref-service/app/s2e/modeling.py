...
# `transformers.modeling_bert` was removed in transformers>=4; ACT2FN now lives in
# transformers.activations. Keep a fallback for the original 3.x layout.
try:
    from transformers.activations import ACT2FN
except ImportError:  # pragma: no cover - legacy transformers 3.x
